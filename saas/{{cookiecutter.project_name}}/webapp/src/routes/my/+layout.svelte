			...
			<SidebarGroup>
				...
				<SidebarItem label="Messages" href="/" {spanClass}>
					...
					<svelte:fragment slot="subtext">
						<span
							class="inline-flex justify-center items-center p-3 ml-3 w-3 h-3 text-sm font-medium text-blue-600 bg-blue-200 rounded-full dark:bg-blue-400 dark:text-gray-900"
							>6</span
						>
					</svelte:fragment>
				</SidebarItem>
				<SidebarDropdownWrapper label="Authentication">
					...
					<SidebarDropdownItem label="Sign Up" href="/" />
					<SidebarDropdownItem label="Forgot Password" href="/" />
				</SidebarDropdownWrapper>
			</SidebarGroup>
			<SidebarGroup border>
				<SidebarItem label="Docs" {spanClass}>
					<svelte:fragment slot="icon">
						<svg
							aria-hidden="true"
							class="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
