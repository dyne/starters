...
export function getCollectionJsonSchema<T extends keyof typeof GeneratedSchema>(
	collection: T
): (typeof GeneratedSchema)[T] {
	return GeneratedSchema[collection];
}

export function getCollectionZodSchema<T extends keyof typeof GeneratedZodSchema>(
	collection: T
